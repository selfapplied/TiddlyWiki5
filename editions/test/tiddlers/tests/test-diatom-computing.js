...
describe("Diatom Computing", function() {
	...
	describe("Frustule Encoding", function() {
		...
		it("should compute flow paths between pores", function() {
			...
			expect(encoded.flowPaths[0]).toHaveProperty('from');
			expect(encoded.flowPaths[0]).toHaveProperty('to');
			expect(encoded.flowPaths[0]).toHaveProperty('flow');
			expect(encoded.flowPaths[0]).toHaveProperty('resistance');
		});
	...
	describe("Growth Iteration", function() {
		...
		it("should converge to fixed point", function() {
			...
			expect(result).toHaveProperty('finalCurvature');
			expect(result).toHaveProperty('fixedPoint');
	...
	describe("Optical Computing", function() {
		...
		it("should create wavelength filters from ridges", function() {
			...
			var ridges = [
				...
				{ height: 0.4, strength: 1.0 }, // Too low
